    ...
    if (data.length === 0) {
        ...
        modifyData.forEach((datum) => {
            ...
            <a class="${datum.subject === 'Maths' ? 'box' : datum.subject === 'Chemistry' ? 'chem-box' : 'phy-box'}" href="${datum.file_link}" target="_blank"">
                ...
                <div>
                    <div>${datum.semester.includes('2022/2023') ? '2022/2023 Semester 2' : (datum.semester === '2023/2024-SMT2' ? '2023/2024 Semester 2' : (datum.semester === '2023/2024-SMT1' ? "2023/2024 Semester 1" : "2024/2025 Semester 1"))}</div>
                </div>
            </a>
        `;
        });
